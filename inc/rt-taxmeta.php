		...
		public function initialize() {
			...
			foreach ( $this->tax_meta as $id => $meta ) {
				if ( ! in_array( $meta['taxonomy'], $tax_done ) ) {
					add_action( "{$meta['taxonomy']}_add_form_fields", [ $this, 'add_tax_fields' ], $meta['priority'] );
					add_action( "{$meta['taxonomy']}_edit_form_fields", [ $this, 'edit_tax_fields' ], $meta['priority'], 2 );
